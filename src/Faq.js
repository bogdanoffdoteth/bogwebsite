...
class Faq extends Component{
  render(){
    const FaqList=[
      ...
      {id:3,title:"What is the duration of the crowdsale?",content:"Crowdsale starts on 15th December and ends on 20th December. However, we'll end the crowdsale once it reaches the ETH hardcap."},
